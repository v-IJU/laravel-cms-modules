        ...
        <div class="login_wrapper">
            <div class="animate form login_form">
                <section class="login_content">
                    {{ Form::open(['url' => route('dobackendlogin'), 'method' => 'post']) }}
                    <h1>Login Form</h1>
                    <div>
                        {!! Form::text('username', Cookie::get('admin_username'), [
                            'id' => 'username',
                            'class' => 'form-control input-fields-input',
                            'required' => 'required',
                    ...
                    <div>
                        {!! Form::checkbox('remember', '1', Cookie::get('admin_username') ? true : false, ['id' => 'remember']) !!}
                    ...
                    <div class="separator">
                        ...
                        <div>
                            <h1><i
                                    class="fa fa-paw"></i>{{ isset(Configurations::getConfig('site')->site_name) ? Configurations::getConfig('site')->site_name : '' }}
                            </h1>
